...
public interface ArticleService {
    ...
    /**
     * 등록된 모든 게시글의 목록(번호, 제목, 댓글 수)을 출력합니다.
     * 등록된 게시글이 없으면 안내 문구를 출력합니다.
     */
    void printAllArticles();

    /**
     * 지정한 게시글 번호의 상세 정보를 출력합니다.
    ...
    /**
     * 현재 게시판에 등록된 게시글의 개수를 출력합니다.
     */
    void printArticleCount();

    /**
     * 게시글 제목에 검색어가 포함된 게시글을 검색하여 출력합니다.
     *
